...
It is required if a formula is provided that it end with `+ gene`
...
content (`gc`) and relative position (`relpos`) splines can be customized
using arguments to the *fitBiasModels* function.
The returned object, `fitpar`, stores the information as
